-- Datos del causante (fallecido) en trámites de pensión de sobrevivencia (JSON en clientes).
ALTER TABLE public.clientes
  ADD COLUMN IF NOT EXISTS causante jsonb;

COMMENT ON COLUMN public.clientes.causante IS 'Persona fallecida (causante) cuando solicitud_tipo_pension es sobrevivencia: nombres, RUT, fechas, AFP, etc.';
